...
<div class="sample-pages-index">
	...
	foreach ($cArray as $cobj):
		...
		$thumb = $cobj->getCollectionAttributeValue('bs_sample_thumbnail');
		$categories = $cobj->getAttribute('bs_sample_category');
		$isFirst = false;
	?>
	<div class="entry <?php  echo $firstClass; ?>">
		<div class="thumbnail-wrap">
			<?php 
			$ih->outputThumbnail($thumb, 200, 200, $title, false, true); 
			?>
		</div>
		<div class="title">
			<h3>
